...
public class Game {
  ...
  static void Main (string[] args) {
        ...
        Thread.Sleep(1000);
        Utility.SlowPrint("Der står: 'Hvis du nogensinde har brug for hjælp, bare sig 'hjælp'. Men dit hovedmål er at overleve og sejle væk fra øen. Der ser dog ikke ud til at være en båd, så du må lave din egen. Held og lykke med at overleve ved at samle mad og ressourcer til at bygge din båd. Alle ressourcer opdateres hver morgen.'", 20);
        Thread.Sleep(1000);
